...
export const resources: Resource[] = [
  ...
  { id: 'res-007', type: 'fire_truck', callSign: 'FIRE-11', status: 'available', location: { lat: 12.9698, lng: 77.6075 }, capacity: 6, assignedIncidentId: null, etaMinutes: null, lastUpdated: '2026-08-14T09:09:00+05:30' },
  { id: 'res-008', type: 'ambulance', callSign: 'MED-18', status: 'available', location: { lat: 12.9648, lng: 77.6191 }, capacity: 4, assignedIncidentId: null, etaMinutes: null, lastUpdated: '2026-08-14T09:09:00+05:30' },
  { id: 'res-009', type: 'rescue_team', callSign: 'RESCUE-21', status: 'available', location: { lat: 12.9821, lng: 77.6134 }, capacity: 10, assignedIncidentId: null, etaMinutes: null, lastUpdated: '2026-08-14T09:08:00+05:30' }
]
